...

    {
      ...
      produtos: [

        {
          ...
          imagem: imgBolo // Imagem de exemplo
          ...
          <div className="caixa-formulario">
            ...
            <form className="formulario">
              ...
              <div className="botoes-form">
                ...
                <button type="button" className="btn-salvar" /*onClick={cadastrarUsuario}*/ onClick={() => setTelaAtual('token-email-usuario')} >CONTINUAR</button>
              </div>
            </form>
          </div>
        </main>
                  ...
                  <div style={{ flex: '1' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '45px' }}>
                      <div style={{ flex: '1' }}> {/* Mantive com flex: 1 para ficar do mesmo tamanho de antes */}
                        ...
                        }} /*onClick={handleCadastroRestaurante}*/ onClick={() => setTelaAtual('token-email-restaurante')} >
                          CONTINUAR
                        </button>
                      </div>
                    </div>
        ...
        <main className="tela-cadastro">
          ...
          <div className="caixa-formulario" style={{ minHeight: 'auto', padding: '50px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '40px' }}>
              <button type="button" className="btn-salvar" style={{ padding: '12px 50px' }} /*onClick={validarRestaurante}*/ onClick={() => setTelaAtual('dashboard')}>
                Finalizar
              </button>
            </div>
          </div>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                  <button style={{ 
                    ...
                    backgroundColor: '#ff3b3b', color: '#fff', fontWeight: 'bold', fontSize: '1.1rem', cursor: 'pointer',
                    boxShadow: '0 4px 10px rgba(255, 59, 59, 0.3)'
                  }} /*onClick={cadastrarProduto}*/ onClick={() => setTelaAtual('dashboard')}>
                    Feito
                  </button>
                </div>
